...
namespace Demo
{
    ...
    internal static class ListGenerator
    {
        ...
        static ListGenerator()
        {
            ...
            // write full path 
            //CustomersList = XDocument.Load("D:\\Career\\Backend\\Courses_Backend\\Eng Ahmed Nasr-1\\05 LINQ\\Session 01\\Demo\\Day 01 LINQ  Route\\Demo\\Customers.xml")
            // or write the name file, but should to be in bin folder 
